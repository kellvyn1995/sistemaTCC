...
<div class="contanier bg-dark text-white  navbar p-3" style="top: 20px;" >
    <div class="row col-12 col-sm-12 col-md-12">
      <div class="col-12 col-sm-12 col-md-6">
        <label for="">REDES SOCIAIS</label> <br>
        <a type="button" class="btn btn-outline-warning"  href="">
        ...
        <a name="instagram" type="button" class="btn btn-outline-warning"  href="https://www.instagram.com/inventiva.top/">
      ...
      <div class="col-12 col-sm-12 col-md-3">
        ...
        <label for="">Tauá, Ceará</label> <br>
        <label for="">Rua 105, Bairro cohab</label>
      </div>
      <div class="col-12 col-sm-12 col-md-3">
